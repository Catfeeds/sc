...
class Builder
{
    ...
    protected function fun_adm_count($array_or_countable,$mode = COUNT_NORMAL){
    ...
    protected function callScope(callable $scope, $parameters = [])
    {
        ...
        $originalWhereCount = $this->fun_adm_count($query->wheres);
    ...
    {
        return $this->fun_adm_count($query->wheres) > $originalWhereCount;
    }
