...
<div class="btn-group margin-bottom">
    ...
    <button class="btn btn-danger btn-xs margin-r-5" id="btn_delete" value="{{ \App\Models\Live::STATE_DELETED }}"
