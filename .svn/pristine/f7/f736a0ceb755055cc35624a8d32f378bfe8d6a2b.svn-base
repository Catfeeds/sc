...
@section('content')
                        ...
                        <div class="box-body">
                            ...
                            <table id="table" data-toggle="table" style="word-break:break-all;">
                                ...
                                <tr>
                                    ...
                                    <th data-field="is_certified" data-align="center" data-width="50"
                                        data-formatter="certifyFormatter">是否认证
                                    </th>
    ...
    <script>
        ...
        function certifyFormatter(value, row) {
            var style = 'label-primary';
            var certify_type = '';
            switch (row.is_certified) {
                case 0:
                    style = 'label-primary';
                    certify_type = '否';
                    break;
            ...
            return [
                '<span class="label ' + style + '">' + certify_type + '</span>',
            ].join('');
        }
