<script src="<?php echo e(url('js/zoom/zoom.min.js')); ?>"></script>
<script>
    ...
    window.actionEvents = {
        ...
        'click .pass': function (e, value, row) {
            $.ajax({
                ...
                data: {
                    ...
                    id: row.id,
                    reason: '',
                    state: <?php echo e(\App\Models\Certification::STATE_SUCCESS); ?>},
        ...
        'click .refuse': function (e, value, row) {
            ...
            $.ajax({
                ...
                type: "get",
                data: {'_token': '<?php echo e(csrf_token()); ?>', id: row.id},
                dataType: 'html',
