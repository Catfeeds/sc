                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.tags.toolbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('admin.tags.table', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('admin.tags.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
