<?php if (app('Illuminate\Contracts\Auth\Access\Gate')->check('create-grade')): ?>
    ...
    <button class="btn btn-danger btn-xs margin-r-5" id="btn_delete" value="<?php echo e(\App\Models\Grade::STATE_DELETED); ?>" onclick="remove()" data-toggle="modal" data-target="#modal">删除</button>
</div>
<?php endif; ?>
