<ul id="tabs" class="nav nav-tabs">
    ...
    <li class="pull-right">
        ...
        <button class="btn btn-info btn-xs margin-r-5 margin-t-5" onclick="location.href='/admin/modules/<?php echo e($module->id); ?>/generate';">生成模块代码</button>
        <button class="btn btn-info btn-xs margin-r-5 margin-t-5" onclick="location.href='/admin/modules/<?php echo e($module->id); ?>/migrate';">生成数据结构</button>
    </li>
</ul>
<div id="tabs_table" class="tab-content">
    <div id="tab_field" class="tab-pane fade in active padding-t-15">
        <div class="form-group">
            <div class="col-sm-12">
                <table id="table_field" data-toggle="table" data-url="/admin/modules/fields/<?php echo e($module->id); ?>/table">
                    <thead>
                    <tr>
    ...
    <div id="tab_column" class="tab-pane fade padding-t-15">
        <div class="form-group">
            <div class="col-sm-12">
                <table id="table_column" data-toggle="table" data-url="/admin/modules/fields/<?php echo e($module->id); ?>/table">
                    <thead>
                    <tr>
                        <th data-field="name" data-width="60">英文名称</th>
                        <th data-field="title" data-width="90">中文名称</th>
    ...
    <div id="tab_editor" class="tab-pane fade padding-t-15">
        <div class="form-group">
            <div class="col-sm-12">
                <table id="table_editor" data-toggle="table" data-url="/admin/modules/fields/<?php echo e($module->id); ?>/table">
                    <thead>
                    <tr>
                        <th data-field="name" data-width="60">英文名称</th>
                        <th data-field="title" data-width="90">中文名称</th>
