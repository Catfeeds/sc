                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-aqua sel-font"><?php echo e($pv); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-red sel-font"><?php echo e($uv); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-yellow sel-font"><?php echo e($ip); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number text-green sel-font"><?php echo e($rm); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                            ...
                            <div class="table-responsive">
                                <table class="table no-margin">
                                    ...
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <tr>
                                            <td><a href="<?php echo e($page->url); ?>" target="_blank"><?php echo e($page->title); ?></a></td>
                                            <td><?php echo e($page->clicks); ?></td>
                                            <td><span class="badge <?php echo e($page->badge); ?>"><?php echo e($page->percent); ?></span></td>
                                        </tr>
                        ...
                        <div class="box-body no-padding">
                            <ul class="users-list clearfix">
                                <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                    <li>
                                        <img src="<?php echo e($member->avatar_url); ?>" alt="User Image">
                                        <span class="users-list-name"><?php echo e($member->nick_name); ?></span>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                            </ul>
                            <!-- /.users-list -->
