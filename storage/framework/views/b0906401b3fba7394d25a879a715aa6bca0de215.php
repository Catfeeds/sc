                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="btn-group margin-bottom pull-right">
                                ...
                                <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-success" value="<?php echo e(\App\Models\PushLog::STATE_SUCCESS); ?>">成功</button>
                                <button type="button" class="btn btn-default btn-xs margin-r-5 filter" data-active="btn-danger" value="<?php echo e(\App\Models\PushLog::STATE_FAILURE); ?>">失败</button>
                                ...
                                <form id="form_query" class="form-horizontal">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <?php echo Form::select('user_id', $users, 0, ['class' => 'form-control']); ?>
