                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            <button class="btn btn-primary btn-xs margin-r-5 margin-t-5"
                                    onclick="window.location.href='/admin/categories/create/<?php echo e($category_id); ?>';"> 新增子分类
                            </button>
                        </div>
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.layouts.modal', ['id' => 'modal_create'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <table id="table"
                                   data-toggle="table"
                                   data-url="/admin/categories/table/<?php echo e($category_id); ?>">
                                <thead>
                                <tr>
        ...
        $('#table').bootstrapTable({
            onEditableSave: function (field, row, old, $el) {
                $.ajax({
                    ...
                    data: {'_token': '<?php echo e(csrf_token()); ?>', 'sort': row.sort},
