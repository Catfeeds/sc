...
<div id="tabContents" class="tab-content">
    <div id="tabHome" class="tab-pane fade in active padding-t-15">
        <div class="form-group">
            <?php echo Form::label('name', '栏目名称:', ['class' => 'control-label col-sm-1']); ?>
        ...
        <div class="form-group">
            <?php echo Form::label('description', '摘要:', ['class' => 'control-label col-sm-1']); ?>

            <div class="col-sm-11">
                <?php echo Form::textarea('description', null, ['rows'=>'4','class' => 'form-control']); ?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input class="form-control" name="image_url" id="image_url" type="text" readonly
                       value="<?php echo e(isset($content->image_url) ? $content->image_url :''); ?>">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-11">
                ...
                <div class="show-oss-img-image_url">
                    <?php if(!empty($content->image_url)): ?>
                        <img src="<?php echo e(config('site.oss.host')); ?>/<?php echo e($content->image_url); ?>" width="100px">
                    <?php endif; ?>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-11">
                <input class="form-control" name="cover_url" id="cover_url" type="text" readonly
                       value="<?php echo e(isset($content->cover_url) ? $content->cover_url :''); ?>">
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-1">上传图片:</label>
            <div class="col-sm-11">
                ...
                <div class="show-oss-img-cover_url">
                    <?php if(!empty($content->cover_url)): ?>
                        <img src="<?php echo e(config('site.oss.host')); ?>/<?php echo e($content->cover_url); ?>" width="100px">
                    <?php endif; ?>
                </div>
