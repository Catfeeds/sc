                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.orders.toolbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('admin.orders.query', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            ...
                            <?php echo $__env->make('admin.orders.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
