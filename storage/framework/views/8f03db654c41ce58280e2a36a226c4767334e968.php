                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <form id="form" action="/admin/dictionaries" method="post" class="form-horizontal">
                                ...
                                <input type="hidden" name="parent_id" value="<?php echo e($parent_id); ?>" id="parent_id">
                                <div class="box-body">
                                    <div class="form-group">
                                        <?php echo Form::label('code', '编码:', ['class' => 'control-label col-sm-2']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('name', '名称:',['class' => 'control-label col-sm-2']); ?>
                                    ...
                                    <div class="form-group">
                                        <?php echo Form::label('value', '值:',['class'=>'control-label col-sm-2']); ?>
