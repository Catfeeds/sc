        ...
        <div class="box box-info">
            <div class="box-body">
                <div class="col-sm-12" style="padding: 0px 0px 10px 0px;">
                    <?php echo Form::textarea('content', null, ['id'=>'content','class' => 'form-control', 'rows' => '4']); ?>
...
<script>
    $('#comment_table').bootstrapTable({
        ...
        queryParams: function (params) {
            params.refer_id = '<?php echo e($refer_id); ?>';
            params.refer_type = "<?php echo e(urlencode($refer_type)); ?>";
        ...
        'click .comment': function (e, value, row, index) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    'refer_id': '<?php echo e($refer_id); ?>',
                    'refer_type': '<?php echo e(urlencode($refer_type)); ?>'
                },
                dataType: 'html',
    ...
    function commit() {
        ...
        $.ajax({
            url: '<?php echo e("/admin/comments/$refer_id/reply"); ?>',
            type: 'post',
            data: {
                'refer_type': '<?php echo e(urlencode($refer_type)); ?>',
                'content': $('#content').val(),
