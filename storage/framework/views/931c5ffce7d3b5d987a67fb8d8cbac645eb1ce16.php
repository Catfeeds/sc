                ...
                <div class="col-md-3">
                    <div class="box box-success">
                        <div class="box-body">
                            ...
                            <?php echo Form::open(['url' => '/admin/menus', 'method' => 'post', 'id' => 'form_create']); ?>

                            <div class="form-group">
                                <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => '请输入菜单名称', 'required', 'id' => 'name']); ?>

                            </div>
                            <div class="form-group">
                                <?php echo Form::text('url', '#', ['class' => 'form-control', 'placeholder' => '请输入菜单URL', 'required', 'id' => 'url']); ?>

                            </div>
                            <div class="form-group">
                                <?php echo Form::text('permission', '', ['class' => 'form-control', 'placeholder' => '请输入权限编码', 'id' => 'url']); ?>

                            </div>
                            <div class="form-group">
                                <div class="input-group">
                                    <?php echo Form::text('icon', 'fa-cube', ['class' => 'form-control', 'placeholder' => '请选择菜单图标', 'id' => 'icon']); ?>
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="dd" id="menu-nestable">
                                <?php echo \App\Helpers\HtmlBuilder::menuEditor($menus); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-info">
                                <?php echo Form::open(['url' => '/admin/menus', 'method' => 'post', 'id' => 'form_edit']); ?>

                                <input id="method" name="_method" type="hidden" value="PUT">
                                <div class="box-body">
                                    <div class="form-group">
                                        <?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => '请输入菜单名称', 'required']); ?>

                                    </div>
                                    <div class="form-group">
                                        <?php echo Form::text('url', '#', ['class' => 'form-control', 'placeholder' => '请输入菜单URL', 'required']); ?>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <?php echo Form::text('icon', 'fa-cube', ['class' => 'form-control', 'placeholder' => '请选择菜单图标']); ?>
