                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box box-info">
                                <div class="box-body">
                                    <?php echo Form::open(['url' => '/admin/galleries/batch/import', 'class' => 'form-horizontal']); ?>

                                    <div class="tab-content">
                                        <div id="info" class="tab-pane fade in active padding-t-15">
                                            <div class="form-group">
                                                <?php echo Form::label('file_url', '文件地址:', ['class' => 'control-label col-sm-1', 'style' => 'width: 10%']); ?>

                                                <div class="col-sm-10">
                                                    <?php echo Form::text('file_url', null, ['class' => 'form-control', 'readonly']); ?>
