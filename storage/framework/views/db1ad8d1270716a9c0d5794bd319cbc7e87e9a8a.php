        ...
        $('#table').bootstrapTable({
            onLoadSuccess: function (options) {
                $(options.data).each(function (k, option) {
                    switch (option.type) {
                        case <?php echo e(\App\Models\Option::TYPE_BOOLEAN); ?>:
                            $('.boolean').editable({
                                source: [
                                    {value: 0, text: '否'},
                                    {value: 1, text: '是'}
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_TEXT); ?>:
                            $('.text').editable({
                                type: 'text',
                                url: function (params) {
                                    save(params)
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_TEXTAREA); ?>:
                            $('.textarea').editable({
                                showbuttons: 'bottom',
                                url: function (params) {
                                    save(params)
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_DATE); ?>:
                            $('.date').editable({
                                format: 'yyyy-mm-dd',
                                combodate: {
                                    maxYear: year,
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_DATETIME); ?>:
                            $('.datetime').editable({
                                placement: 'top',
                                combodate: {
                                    maxYear: year,
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_SINGLE); ?>:
                            $('.single').editable({
                                source: [
                                    {value: 1, text: '男'},
                                    {value: 2, text: '女'}
                            ...
                            break;
                        case <?php echo e(\App\Models\Option::TYPE_MULTIPLE); ?>:
                            $('.select').editable({
            ...
            onEditableSave: function (field, row, old, $el) {
                row._token = '<?php echo e(csrf_token()); ?>';
                $.ajax({
