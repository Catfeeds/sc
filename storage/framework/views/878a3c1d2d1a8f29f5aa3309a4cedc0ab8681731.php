<script>
    ...
    function createFile(name) {
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo e(url('admin/themes/file')); ?>',
            data: {'_token': '<?php echo e(csrf_token()); ?>', 'path': path, 'name' : name, 'extension':extension},
            success: function (data) {
    ...
    function removeFile(path) {
        ...
        $.ajax({
            ...
            async: false,
            url: '<?php echo e(url('admin/themes/file')); ?>',
            data: {'_token': '<?php echo e(csrf_token()); ?>', '_method': 'delete', 'path': path},
            success: function () {
                window.location.reload();
            },
            error: function () {
    ...
    function writeFile(path, data) {
        ...
        $.ajax({
            ...
            async: false,
            url: '<?php echo e(url('admin/themes/file')); ?>',
            data: {'_token': '<?php echo e(csrf_token()); ?>', '_method': 'put', 'path': path, 'data': data},
            success: function (data) {
                if (data.code == 200) {
    ...
    function refresh(module_id, page) {
        $.ajax({
            type: 'get',
            url: '<?php echo e(url('admin/themes/modules')); ?>' + '/' + module_id,
