                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.layouts.confirm', ['message' => '您确认注销该条信息吗？'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php echo $__env->make('admin.users.tree', ['id' => 'modal_category'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
