<?php $__env->startSection('content'); ?>
    <script src="<?php echo e(url('plugins/ace/1.2.7/ace.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/ace/1.2.7/ext-language_tools.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/ace/1.2.7/ext-emmet.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/ace/1.2.7/emmet-core/emmet.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/ace/1.2.7/theme-monokai.js')); ?>"></script>
                ...
                <div class="col-md-9">
                    <div class="box box-info">
                        <div class="box-header ui-sortable-handle">
                            ...
                            <div class="box-tools pull-right">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <?php $__currentLoopData = $snippets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $snippet): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <li><a href="javascript:void(0)" class="code" data-code="<?php echo e($snippet); ?>"><?php echo e($key); ?></a></li>
                        ...
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.themes.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startSection('js'); ?>
    <?php echo $__env->make('admin.themes.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
