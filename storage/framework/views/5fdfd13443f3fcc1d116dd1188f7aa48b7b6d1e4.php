...
<script>
    ...
    var expire = 0;
    uploader(elementId, module, callback, uploaderId, options, ossfileid1, showossimg1, container1, expire);

    uploader(elementId2, module, callback2, uploaderId, options, ossfileid2, showossimg2, container2, expire);
</script>