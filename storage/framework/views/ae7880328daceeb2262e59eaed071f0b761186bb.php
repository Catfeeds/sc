                ...
                <div class="col-xs-12">
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <?php echo $__env->make('admin.layouts.modal', ['id' => 'modal_certify'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <div class="btn-group margin-bottom pull-right">
                                ...
                                <button type="button" class="btn btn-default btn-xs margin-r-5 filter"
                                        ...
                                        value="<?php echo e(\App\Models\Certification::STATE_CERTIFING); ?>">待审核
                                </button>
                                <button type="button" class="btn btn-default btn-xs margin-r-5 filter"
                                        data-active="btn-success"
                                        value="<?php echo e(\App\Models\Certification::STATE_SUCCESS); ?>">审核通过
                                </button>
                                <button type="button" class="btn btn-default btn-xs margin-r-5 filter"
                                        data-active="btn-danger"
                                        value="<?php echo e(\App\Models\Certification::STATE_FAILURE); ?>">拒绝认证
                                </button>
                            </div>
                            ...
                            <?php echo $__env->make('admin.members.script', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
