                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <form id="form_push" method="post" class="form-horizontal">
                                <?php echo Form::hidden('module_id', $module->id, ['id' => 'module_id', 'class' => 'form-control']); ?>

                                <?php echo Form::hidden('push_id', null, ['id' => 'push_id', 'class' => 'form-control']); ?>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?php echo Form::select('ios', \App\Models\PushLog::IOS_PUSH_OPTIONS, null, ['class' => 'form-control']); ?>

                                        </div>
                                        <label class="col-sm-2 control-label">Android:</label>
                                        <div class="col-sm-4">
                                            <?php echo Form::select('android', \App\Models\PushLog::ANDROID_PUSH_OPTIONS, null, ['class' => 'form-control']); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <?php echo Form::text('tag', null, ['class' => 'form-control']); ?>
